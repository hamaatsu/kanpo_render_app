...

{
  ...
  "guidance": {
    "療養の要点": "日常生活や食養生の指導内容を簡潔にまとめる（200字以内）",
    "おすすめ薬膳食材": [
...
- 妊婦禁忌の処方（例：桃核承気湯、桂枝茯苓丸、防風通聖散など）は、reasonに「妊婦禁忌」と明記する。
"""
